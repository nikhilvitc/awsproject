...
# Create CloudFront Distribution for Backend HTTPS
...
# Create CloudFront distribution configuration for backend
    ...
    "Items": [
      {
        ...
        "ForwardedValues": {
          ...
          "Headers": {
            "Quantity": 6,
            "Items": ["Authorization", "Content-Type", "Origin", "Referer", "X-Requested-With", "Accept"]
          }
        },
        "MinTTL": 0,
        "DefaultTTL": 0,
      ...
      },
      {
        ...
        "ForwardedValues": {
          ...
          "Headers": {
            "Quantity": 8,
            "Items": ["Authorization", "Content-Type", "Origin", "Referer", "X-Requested-With", "Accept", "Upgrade", "Connection"]
          }
        },
        "MinTTL": 0,
        "DefaultTTL": 0,
